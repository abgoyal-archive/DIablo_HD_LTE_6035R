...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the ext amp control for speaker mode for viper, spyder*/
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2012/10/25, Add the PA control for HAC function for viper, spyder*/
#ifdef CONFIG_TCT_8X30_COMMON
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/28, Using the MBCH calibration data from fw for viper*/
#ifdef CONFIG_TCT_8X30_COMMON
    .read_fw_bin = true,
#else
	.read_fw_bin = false,
...
/*[PLATFORM]-Mod-END by TCTNB.WQF*/
	...
	.gpio = 0,
	.gpio_irq = 0,
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2013/1/3, Modify the headset gpio detect level for spyder,viper*/
#ifdef CONFIG_TCT_8X30_COMMON
    .gpio_level_insert = 0,
#else
	.gpio_level_insert = 1,
...
/*[PLATFORM]-Del-BEGIN by TCTNB.WQF, 2013/1/2, Add the ext amp control for speaker mode for viper, spyder*/
#ifdef CONFIG_TCT_8X30_COMMON
#else
				pm8xxx_spk_enable(MSM8930_SPK_ON);
#endif
...
static const struct snd_soc_dapm_route common_audio_map[] = {
	...
	/* Microphone path */
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2013/1/3, Modify the MIC BIAS for main mic for spyder,viper*/
#ifdef CONFIG_TCT_8X30_COMMON
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2013/1/3, Modify the MIC BIAS for second mic for spyder,viper*/
#ifdef CONFIG_TCT_8X30_COMMON
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/5/8, Add the PA control for HAC function for diablo_lte*/
#ifdef CONFIG_TCT_8X30_COMMON
	SOC_ENUM_EXT("HAC PA Enable", msm8930_enum[5], msm8930_get_hac,
		msm8930_set_hac),
#endif
/*[PLATFORM]-Add-END by TCTNB.WQF*/
