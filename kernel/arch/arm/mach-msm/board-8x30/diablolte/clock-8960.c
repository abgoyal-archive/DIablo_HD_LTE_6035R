...
//	CLK_LOOKUP("iface_clk",		gsbi5_p_clk.c, "msm_serial_hsl.0"),
	...
	CLK_LOOKUP("mem_clk",		rpm_msg_ram_p_clk.c,	""),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-001a"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-006c"),//[PLATFORM]-Mod-BEGIN by TCTNB.ZL, 2012/11/22, for viper back camera, refer to bug318621*/
/*[PLATFORM]-Add-BEGIN by TCTNB.ZL, 2012/11/22, for viper front camera, refer to bug318623*/
	CLK_LOOKUP("cam_clk",		cam1_clk.c, "4-0060"),//ov2675
/*[PLATFORM]-Add-END by TCTNB.ZL*/
/*[PLATFORM]-Add-BEGIN by TCTNB.ZL, 2012/12/12, for viper front camera, refer to bug371383*/
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0042"),
/*[PLATFORM]-Add-END by TCTNB.ZL*/
/*[PLATFORM]-Add-BEGIN by TCTNB.HJ, 2013/04/03, BUG[433213] Sub Camera driver dev*/
    CLK_LOOKUP("cam_clk",       cam1_clk.c, "4-0078"),//s5k8aayx
