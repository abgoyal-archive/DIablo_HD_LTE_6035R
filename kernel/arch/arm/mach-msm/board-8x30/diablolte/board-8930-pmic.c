...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/1/8, And the PM_GPIO1 control for flash led*/
	PM8038_GPIO_OUTPUT_FUNC(1, 0, PM_GPIO_FUNC_1),
/*[PLATFORM]-Add-END by TCTNB.WQF*/
	/* MHL PWR EN */
	PM8038_GPIO_OUTPUT_VIN(5, 1, PM8038_GPIO_VIN_VPH),
};
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/19, And the PM_GPIO1 control for flash led*/
struct pm8xxx_gpio_init pm8038_flashled_gpio_modes[] = {
        PM8038_GPIO_OUTPUT_FUNC(1, 0, PM_GPIO_FUNC_NORMAL), //gpio mode, turn off
        PM8038_GPIO_OUTPUT_FUNC(1, 1, PM_GPIO_FUNC_NORMAL), //gpio mode, turn on
        PM8038_GPIO_OUTPUT_FUNC(1, 0, PM_GPIO_FUNC_1), //pwm mode
};

void msm8930_pm8038_flashled_mode_config(int mode)
{
        pm8xxx_gpio_config(pm8038_flashled_gpio_modes[mode].gpio,
                           &pm8038_flashled_gpio_modes[mode].config);
}
/*[PLATFORM]-Add-END by TCTNB.WQF*/
...
static struct pm8xxx_rtc_platform_data pm8xxx_rtc_pdata __devinitdata = {
	...
	.rtc_alarm_powerup	=  true,//false ,/* [FEATURE]-MOD- by TCTNB.XQJ, 2013/06/03, FR#456484, transfer POWER OFF state alarm */
};
...
/* [FEATURE]-Mod-BEGIN by TCTNB.Alvin, 2013/01/21, FR#392469, Modify the max voltage to 4.35V (Old: 4.2V) */
#define MAX_VOLTAGE_MV		4350
/* [FEATURE]-Mod-END by TCTNB.Alvin */
...
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	...
	.cool_temp		= 0, // [FEATURE]-Mod by TCTNB.WQF, 2013/03/17, IEEE 1725, Old value: 10/* [FEATURE]-Add-BEGIN by TCTNB.YuBin, 2013/08/14, Temperature control during charging,FR503138, old value 5 */
	.warm_temp		= 45,
	.temp_check_period	= 1,
	.max_bat_chg_current	= 1100,
	.cool_bat_chg_current	= 1100,/* [FEATURE]-Add-BEGIN by TCTNB.YuBin, 2013/08/14, Temperature control during charging,FR503138, old value 350 */
	.warm_bat_chg_current	= 350,
	.cool_bat_voltage	= 4350, // [FEATURE]-Mod by TCTNB.WQF, 2013/03/17, IEEE 1725, Old value: 4100
	.warm_bat_voltage	= 4100,
/* [FEATURE]-Add-BEGIN by TCTNB.WQF, 2013/05/15, Add ID detect function */
	.batt_id_min        = 1000000,
	.batt_id_max        = 1400000,
/* [FEATURE]-Add-END by TCTNB.WQF, 2013/05/15 */
	.thermal_mitigation	= pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(pm8921_therm_mitigation),
	.led_src_config		= LED_SRC_VPH_PWR,
	.rconn_mohm		= 18,
/* [FEATURE]-Add-BEGIN by TCTNB.WQF, 2013/05/15, Enable long time charger off function */
	.stop_chg_upon_expiry = 1,
/* [FEATURE]-Add-END by TCTNB.WQF, 2013/05/15 */
/* [FEATURE]-Add-BEGIN by TCTNB.YuBin, 2013/08/14, Temperature control during charging,FR503138 */
	.btc_override = 1,
	.btc_override_cold_degc = 0,
	.btc_override_hot_degc = 55,
	.hot_hysteresis_temp = 5,
	.cold_hysteresis_temp = 2,
/* [FEATURE]-Add-END by TCTNB.YuBin, 2013/08/14 */
};

/* [FEATURE]-Mod-BEGIN by TCTNB.Alvin, 2013/01/25, Change the Max lcd backlight current to 20mA, Old value: 25 */
#define PM8038_WLED_MAX_CURRENT		20
/* [FEATURE]-Mod-END by TCTNB.Alvin */

#define PM8XXX_LED_PWM_PERIOD		1000
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/28, Modify the leds PWM control*/
...
#if (defined(CONFIG_MACH_MSM8X30_VIPER) || defined(CONFIG_MACH_MSM8X30_DIABLOLTE))
	[1] = {
		.name			= "led_red",
	},
	[2] = {
...
static struct wled_config_data wled_cfg = {
	...
	.ctrl_delay_us = 0,
	.op_fdbck = true,
/* [FEATURE]-Mod-BEGIN by TCTNB.WQF, 2013/07/19, change ovp from 32V to 27V just for diablo_hd_lte*/
	.ovp_val = WLED_OVP_37V,
/* [FEATURE]-Mod-END by TCTNB.WQF, 2013/07/19 */
	.boost_curr_lim = WLED_CURR_LIMIT_525mA,
	.num_strings = 2, /* [FEATURE]-Mod by TCTNB.Alvin, 2013/01/25, PR#394005, Change the wled string number, Old value: 1 */
};
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/2/28, Enable the blink function for leds*/
	.use_pwm = 1,
/*[PLATFORM]-Add-END by TCTNB.WQF*/
};
