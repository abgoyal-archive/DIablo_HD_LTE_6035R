...
static struct wcd9xxx_pdata sitar_platform_data = {
	...
	.micbias = {
		...
		.cfilt1_mv = 1800,
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2012/11/28, Set mic bias to 2700mv to support iphone headset*/
        .cfilt2_mv = 2700,
...
/*[PLATFORM]-Mod-BEGIN by TCTNB.WPL, 2013/01/17, Add the wakeup control for viper */
#if (defined(CONFIG_MACH_MSM8X30_VIPER) || defined(CONFIG_MACH_MSM8X30_DIABLOLTE))
#define FT5X06_WAKEUP_GPIO	22
#endif
/*[PLATFORM]-Mod-END by TCTNB.WPL*/
...
/*[FEATURE]-Mod-BEGIN by TCTNB.HJ, 2013/08/14*/
    if(TP_VENDOR == IS_OGS_TP){
        /*[FEATURE]-Mod-BEGIN by TCTNB.WQF, 2013/03/25, for diablo_lte TP*/
        pr_debug("[%s]: 1st tp\n", __func__);
        return snprintf(buf, 200,
        __stringify(EV_KEY) ":" __stringify(KEY_MENU)  ":600:1350:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":360:1350:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":200:1350:100:60"
        "\n");
        /*[FEATURE]-Mod-END by TCTNB.WQF*/
    }else if(TP_VENDOR == IS_TDT_TP){
        pr_debug("[%s]: 2rd tp\n", __func__);
        return snprintf(buf, 200,
        __stringify(EV_KEY) ":" __stringify(KEY_MENU)  ":570:1340:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":330:1340:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":150:1340:100:60"
        "\n");
    }else{
        pr_debug("[%s]: default tp value\n", __func__);
        return snprintf(buf, 200,
        __stringify(EV_KEY) ":" __stringify(KEY_MENU)  ":600:1350:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":360:1350:100:60"
        ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":200:1350:100:60"
...
/*[FEATURE]-Mod-BEGIN by TCTNB.HJ, 2013/02/28, for diabloLTE TP*/
	.x_max		= 720,
	.y_max		= 1280,
/*[FEATURE]-Mod-END by TCTNB.HJ*/
...
struct akm8963_platform_data akm_platform_data_8963 = {
	.layout =4,//6 ,/*[BUGFIX]-Mod-BEGIN by TCTNB.XQJ, 2013/04/03 ,Modify compass direction error problem , refer to bug434335*/
...
static struct bma222_accl_platform_data bma_pdata = {
	.orientation = BMA_ROT_90,/*[BUGFIX]-Mod-BEGIN by TCTNB.XQJ, 2013/03/27 ,Modify for layout , refer to bug428624*/
	.invert =true,/*[BUGFIX]-Mod-BEGIN by TCTNB.XQJ, 2013/03/27 ,Modify for layout , refer to bug428624*/
	.init = NULL,
};
static struct i2c_board_info bma222_i2c_info[] __initdata = {
	{
/*[PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2013/03/12, Modify the I2C slave address for BMA222E */
		I2C_BOARD_INFO("bma222_accl", 0x18),
/*[PLATFORM]-Mod-END by TCTNB.WQF*/
...
static struct msm_i2c_platform_data msm8960_i2c_qup_gsbi4_pdata = {
	.clk_freq = 400000,//[BUGFIX]-Mod by TCTNB.Tang.Ding,06/14/2013,467454,
