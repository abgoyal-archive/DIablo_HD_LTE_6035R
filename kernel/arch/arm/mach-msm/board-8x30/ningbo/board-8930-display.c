...
#define MIPI_CMD_NT35516_QHD_PANEL_NAME "mipi_video_nt35516_qhd"
/* [PLATFORM]-Add-END by TCTNB.Alvin */
/* [PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/4,  Using video mode for diablo */
//#if defined(FEATURE_TCTNB_MMITEST)
#if 1
#define MIPI_NT35510_VIPER_FWVGA_PANEL_NAME "mipi_video_nt35510_viper_fwvga"
#else
#define MIPI_NT35510_VIPER_FWVGA_PANEL_NAME "mipi_cmd_nt35510_viper_fwvga"
#endif
...
/* [PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/26,  Add ssd2825 for diablolte */
#define MIPI_VIDEO_SSD2825_720P_PANEL_NAME "mipi_video_ssd2825_720p"
...
{
/* [PLATFORM]-Mod-BEGIN by TCTNB.peipei.mao, 2013/4/29,  Use ssd2825 for ningbo */
#if defined(CONFIG_MACH_MSM8X30_NINGBO)
    if (!strncmp(name, MIPI_VIDEO_SSD2825_720P_PANEL_NAME,
		strnlen(MIPI_VIDEO_SSD2825_720P_PANEL_NAME,
			PANEL_NAME_MAX_LEN)))
	return 0;
/* [PLATFORM]-Mod-BEGIN by TCTNB.WQF, 2013/3/26,  Use ssd2825 for diablolte */
#elif  defined(CONFIG_MACH_MSM8X30_DIABLOLTE)
    if (!strncmp(name, MIPI_VIDEO_SSD2825_720P_PANEL_NAME,
		strnlen(MIPI_VIDEO_SSD2825_720P_PANEL_NAME,
			PANEL_NAME_MAX_LEN)))
	return 0;
#elif defined(CONFIG_MACH_MSM8X30_VIPER)
#if 1
	if (!strncmp(name, MIPI_NT35510_VIPER_FWVGA_PANEL_NAME,
			strnlen(MIPI_NT35510_VIPER_FWVGA_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#else
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YJ, 2013/1/22, define to ignore first Lcd reset */
static bool first_lcd_reset;
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.Alvin, 2012/10/15,  Change the lcd reset signal */
        ...
        msleep(10);
        gpio_direction_output(DISP_RST_GPIO, 1);
        gpio_direction_output(DISP_3D_2D_MODE, 1);
        msleep(120);
#endif
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/25, Enable the splash function*/
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YJ, 2012/12/12,  Add nt35510 data for viper */
static struct mipi_dsi_phy_ctrl dsi_nt35510_viper_cmd_mode_phy_db = {
...
static struct mipi_dsi_panel_platform_data nt35510_viper_pdata = {
    .phy_ctrl_settings = &dsi_nt35510_viper_cmd_mode_phy_db,
    .dlane_swap = 0x0,
    .enable_wled_bl_ctrl = 0x1,
};

static struct platform_device mipi_dsi_nt35510_viper_panel_device = {
    .name = "mipi_nt35510_viper",
    .id = 0,
    .dev = {
        .platform_data = &nt35510_viper_pdata,
    }
};
/* [PLATFORM]-Add-END by TCTNB.YJ */

/* [PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/26,  Add ssd2825 data for diablolte */
static struct mipi_dsi_panel_platform_data ssd2825_diablolte_pdata = {
    .dlane_swap = 0x0,
    .enable_wled_bl_ctrl = 0x1,
};

static struct platform_device mipi_dsi_ssd2825_diablolte_panel_device = {
    .name = "mipi_ssd2825",
    .id = 0,
    .dev = {
        .platform_data = &ssd2825_diablolte_pdata,
    }
};
/* [PLATFORM]-Add-END by TCTNB.YJ */
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YJ, 2012/12/12,  Add NT35510 for Viper */
    platform_device_register(&mipi_dsi_nt35510_viper_panel_device);
/* [PLATFORM]-Add-END by TCTNB.Alvin */

/* [PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/3/26,  Add ssd2825 for diablolte */
    platform_device_register(&mipi_dsi_ssd2825_diablolte_panel_device);
/* [PLATFORM]-Add-END by TCTNB.WQF */
