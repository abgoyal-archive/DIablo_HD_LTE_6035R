...
#if (defined(CONFIG_MACH_MSM8X30_VIPER) || defined(CONFIG_MACH_MSM8X30_DIABLOLTE) || defined(CONFIG_MACH_MSM8X30_NINGBO))
	[1] = {
		.name			= "led_red",
	},
	[2] = {
...
static struct pm8921_bms_platform_data pm8921_bms_pdata __devinitdata = {
	...
	.r_sense_uohm			= 10000,
	.v_cutoff			= 3000, // [FEATURE]-Mod by TCTNB.Alvin, 2013/03/29, PR#431938, Old value: 3400
