 ...
 * --------   ---     ----------------------------------------------------------
 * 01/11/13   WQF    Change the order of the command of tear off and display off for command mode
 */
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/1/11, Change the order of the command of tear off and display off for command mode*/
...
/*[PLATFORM]-Del-BEGIN by TCTNB.WQF, 2013/1/11, Change the order of the command of tear off and display off for command mode*/
#ifndef CONFIG_TCT_8X30_COMMON
	ret = panel_next_off(pdev);
#endif
