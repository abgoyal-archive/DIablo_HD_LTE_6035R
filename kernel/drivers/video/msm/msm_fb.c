...
/*-----------------------------------------------------------------------------*/
/* 12/12/13| Liu Jie        | PR-370247 372823 372425             | temporary solution for light up screen    */
/*=============================================================================*/
...
#if 0//wqf for power on backlight
						...
						struct mdp_bl_scale_data *data)
{
	...
	int curr_bl;
	down(&mfd->sem);
/*[BUGFIX]-Mod-BEGIN by TCTNB.Liu Jie, 2012/12/13 PR-370247 372823 372425, temporary solution for light up screen  */
        //curr_bl = mfd->bl_level;
        if(unset_bl_level){
        curr_bl = unset_bl_level;
       }else{
        curr_bl = mfd->bl_level;
       }
/*[BUGFIX]-Mod-END by TCTNB.Liu Jie*/
	bl_scale = data->scale;
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YJ, 2013/8/6, speed up light up time, refer to PR-490701 */
