		...
		unsigned led_state)
{
	...
	case MSM_CAMERA_LED_INIT:
		...
		gpio_tlmm_config(GPIO_CFG(external->led_flash_en, 0, GPIO_CFG_OUTPUT,//[PLATFORM]-Add by TCTNB.ZL,2013/02/02,PR401033
...
/*[PLATFORM]-Add-BEGIN by TCTNB.ZL, 2013/1/3, Add the camera flash led control for viper V01*/
#ifdef CONFIG_TCT_8X30_COMMON
		led_flash_set_brightness(LED_OFF);
#endif
...
/*[PLATFORM]-Add-BEGIN by TCTNB.ZL, 2013/1/3, Add the camera flash led control for viper V01*/
#ifdef CONFIG_TCT_8X30_COMMON
		led_flash_set_brightness(LED_FULL);
#endif
/*[PLATFORM]-Add-END by TCTNB.ZL*/
		gpio_set_value_cansleep(external->led_en, 1);
		gpio_set_value_cansleep(external->led_flash_en, 0);//[PLATFORM]-Add by TCTNB.ZL,2012/11/27,add this for V00 Viper
		break;
