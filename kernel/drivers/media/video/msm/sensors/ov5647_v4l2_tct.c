 ...
 * --------------------------------------------------------------------------------------
 * 12/12/26      Xu Nan         Modify binning_factor for over exposure issue,PR381680
 * --------------------------------------------------------------------------------------
 * 13/02/16      Xu Nan         fix ripple issue,PR404151
 * --------------------------------------------------------------------------------------
 */
...
#if 0
static struct msm_camera_i2c_reg_conf ov5647_reset_settings[] = {
	{0x0103, 0x01},
};
#endif
...
static struct msm_camera_i2c_conf_array ov5647_init_conf[] = {
	//{&ov5647_reset_settings[0],
	//ARRAY_SIZE(ov5647_reset_settings), 50, MSM_CAMERA_I2C_BYTE_DATA},
...
static struct msm_sensor_output_info_t ov5647_dimensions[] = {
	{ /* For SNAPSHOT */
		...
		//[BUGFIX]-Mod by TCTBN.XuNan,2/16/2013,PR404151,fix snapshot ripple 82000000 -> 79704000
		.vt_pixel_clk = 79704000,//82000000,
		.op_pixel_clk = 90000000,
        //[BUGFIX]-Mod by TCTBN.XuNan,12/26/2012,PR381680,fix over exposure issue 1->0x0
		.binning_factor = 0x0,
	},
	{ /* For PREVIEW */
		.x_output = 0x500, /*1280*/
		...
		//[BUGFIX]-Mod by TCTBN.XuNan,2/16/2013,PR404151,fix preview ripple 82000000 -> 55969920
		.vt_pixel_clk = 55969920,//82000000,
		.op_pixel_clk = 90000000,//408M
        //[BUGFIX]-Mod by TCTBN.XuNan,12/26/2012,PR381680,fix over exposure issue 2->0x0
		.binning_factor = 0x0,
	},
	{ /* For 60fps */
		.x_output = 0x280,  /*640*/
...
static const struct of_device_id ov5647_dt_match[] = {
	{.compatible = "qcom,ov5647", .data = &ov5647_s_ctrl},
	{}
};
