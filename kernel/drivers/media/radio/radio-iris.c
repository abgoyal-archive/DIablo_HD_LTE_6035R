...
/* ----------|----------------------|----------------------|----------------- */
/* 06/13/2013|      Tang.Ding       |      PR- 467489      |[Performance]Sea- */
/*           |                      |                      |rch all channels  */
/*           |                      |                      |is too long in FM */
/*           |                      |                      | Radio automatic- */
/*           |                      |                      |ally              */
/* ----------|----------------------|----------------------|----------------- */
/* 2013-07-17|Zhenjun.zhang         |484354                | fm force kill    */
/******************************************************************************/
	...
	struct sk_buff *skb)
{
	...
	if (status)
		return;
	//[BUGFIX]-ADD-BEGIN by TCTNB.Zhenjun.zhang, PR-484354, 2013-07-17, fm force kill
	if ((radio->mode != FM_CALIB) && (radio->mode != FM_OFF))
		iris_q_event(radio, IRIS_EVT_RADIO_DISABLED);
	radio->mode = FM_OFF;
	//[BUGFIX]-ADD-END by TCTNB.Zhenjun.zhang
...
static int iris_do_calibration(struct iris_device *radio)
{
	...
	radio->mode = FM_TURNING_OFF;//[BUGFIX]-ADD-BEGIN by TCTNB.Zhenjun.zhang, PR-484354, 2013-07-17, fm force kill
	return retval;
}
