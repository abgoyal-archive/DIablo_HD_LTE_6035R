...
/* ----------|----------------------|----------------------|----------------- */
/* 07/29/2013|      meng.tong       |      PR-484356       |Back to home scr- */
/*           |                      |                      |een when view we- */
/*           |                      |                      |bsite             */
/* ----------|----------------------|----------------------|----------------- */
/******************************************************************************/
...
PassOwnPtr<MediaQueryEvaluator> MediaQueryMatcher::prepareEvaluator() const
{
    ...
    //[BUGFIX]-Mod-BEGIN by TCTNB.meng.tong,07/29/2013,484356,
    //Back to home screen when view website
    ...
    //[BUGFIX]-Mod-END by TCTNB.meng.tong
